...
class ModelTrainer:
  ...
  def initiate_model_trainer(self,train_array, test_array):
    try:
      ...
      mlflow.set_registry_uri("https://dagshub.com/bjbcr7/DSproject.mlflow")
      tracking_url_type_store = urlparse(mlflow.get_tracking_uri()).scheme
      
      with mlflow.start_run():
        
        predicted_qualtities = best_model.predict(X_test)
        
        (rmse, mae, r2) = self.eval_metrics(y_test, predicted_qualtities)
